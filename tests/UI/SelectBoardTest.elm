...
selectBoardTests =
    describe "The UI should render the select board size element"
        [ fuzz randomBoardSize "displaying the board size that is currently being played (Standard)" <|
             \aBoardSize ->
        ...
        , test "not including any option for games that are not HumanVsHuman (HvC)" <|
            \() ->
        ...
        , test "not including any option for games that are not HumanVsHuman (CvC)" <|
            \() ->
